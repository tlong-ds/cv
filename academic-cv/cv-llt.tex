...
\leftheader{%
  {\LARGE\bfseries\sffamily THANH LONG LY}

  \makefield{\faEnvelope[regular]}{\href{mailto:lytlong.pers@gmail.com}{\texttt{lytlong.pers@gmail.com}}}
  \makefield{\faEnvelope}{\href{mailto:longlythanh.pmmla@neu.edu.vn}{\texttt{longlythanh.pmmla@neu.edu.vn}}}
  \par
  ...
  \makefield{{\scriptsize\simpleicon{github}}}{\!\href{https://github.com/tlong-ds}{\texttt{@tlong-ds}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/thành-long-lý-565b6a341/}{\texttt{Thanh Long Ly}}}
  \makefield{\faPhone}
  {\href{tel:+84 868 421 575}{\texttt{+84 868 421 575}}}
  %% Next line
